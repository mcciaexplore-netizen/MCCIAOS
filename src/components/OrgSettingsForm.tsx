...
export const ORG_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'dailyExportTime', label: 'Daily export time', kind: 'time', half: true, help: 'IST. The scheduled run is fixed at 17:00 by the cron in vercel.json — changing this records your intent but does not move it.' },
